...
img_path = '/home/cai/Desktop/yolo_dataset/objectdetection/JPEGImages/'                   #原图.jpg文件的路径
labels_path = '/home/cai/Desktop/yolo_dataset/objectdetection/labels/'                    #labels中.txt文件的路径
annotations_path = '/home/cai/Desktop/yolo_dataset/objectdetection/Annotations/'          #生成的xml文件需要保存的路径
labels = os.listdir(labels_path)
clsnames_path = '/home/cai/Desktop/yolo_dataset/objectdetection/yolo3_object.names'     #names文件的路径
...
def write_xml(imgname,filepath,labeldicts):                     #参数imagename是图片名（无后缀）
    ...
    ET.SubElement(sizes, 'width').text = '1920'                 #没带脑子直接写了原图片的尺寸......
    ET.SubElement(sizes, 'height').text = '1080'
...
for label in labels:                                           #批量读.txt文件
    with open(labels_path + label, 'r') as f:
        ...
        for content in contents:
            img = np.array(Image.open(img_path+'t'+label.strip('.txt') + '.jpg'))
        ...
        write_xml(img_id, annotations_path + 't' + label.strip('.txt') + '.xml', labeldicts)
#makexml("/home/cai/Desktop/yolo_dataset/objectdetection/labels/","/home/cai/Desktop/yolo_dataset/objectdetection/Annotations/","/home/cai/Desktop/yolo_dataset/objectdetection/JPEGImages/")
